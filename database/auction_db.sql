-- =====================================================================
-- Online Auction System - SQLite schema
--
-- Dùng SQLite cho gọn — chỉ là 1 file .db trong thư mục, không cần server.
-- Server tự động tạo file này lúc start nếu chưa có (xem SchemaInitializer).
-- File này được giữ lại để dễ đọc cấu trúc bảng / chạy thủ công bằng:
--     sqlite3 auction.db < database/auction_db.sql
--
-- Kiểu dữ liệu SQLite linh hoạt — INTEGER PRIMARY KEY tự động AUTOINCREMENT.
-- =====================================================================
...
VALUES ('iPhone 15 Pro', 'Hàng chính hãng, like new', 25000000, 'ELECTRONICS',
...
VALUES ('Bức tranh Sơn dầu', 'Phong cảnh thế kỷ 19', 8000000, 'ART',
        (SELECT id FROM users WHERE username='alice_s'),
        'Vincent', 1885);

INSERT INTO items (name, description, starting_price, category, seller_id, make, model, mileage)
VALUES ('Toyota Camry 2018', 'Xe gia đình giữ kỹ', 650000000, 'VEHICLE',
